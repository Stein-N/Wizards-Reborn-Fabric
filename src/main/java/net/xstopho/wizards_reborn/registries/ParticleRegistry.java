...
public class ParticleRegistry {
    ...
    public static ParticleType<GenericParticleData> ARCANE_WOOD_LEAF_PARTICLE =
            register("arcane_wood_leaf", FabricParticleTypes.complex(new ArcaneWoodLeafParticleType().getParametersFactory()));

    public static ParticleType<GenericParticleData> SPARKLE_PARTICLE =
            register("sparkle", FabricParticleTypes.complex(new SparkleParticleType().getParametersFactory()));

    public static ParticleType<GenericParticleData> WISP_PARTICLE =

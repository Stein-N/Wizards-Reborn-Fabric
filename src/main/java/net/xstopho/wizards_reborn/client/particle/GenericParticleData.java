...
public class GenericParticleData implements ParticleEffect {
    ...
    public static final Factory<GenericParticleData> DESERIALIZER = new Factory<GenericParticleData>() {
        @Override
        public GenericParticleData read(ParticleType<GenericParticleData> type, StringReader reader) throws CommandSyntaxException {
            reader.expect(' ');
        ...
        @Override
        public GenericParticleData read(ParticleType<GenericParticleData> type, PacketByteBuf buf) {

...
public enum CustomItemToolMaterial implements ToolMaterial {
    ...
    private CustomItemToolMaterial(int miningLevel, int itemDurability, float miningSpeed, float attackDamage, int enchantability, Supplier<Ingredient> repairIngredient) {
